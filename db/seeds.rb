...
settings = {
  ...
  "picture_style_categories" => "border",
  "picture_style_services" => "border",
  "picture_style_providers" => "border",
  "booking_provider_first" => "0",
  "display_order_switch" => "1",
